    ...
    educations: [
      {
        ...
        description: [
          ...
          "We are also expected to master the management, storage, and presentation of data with optimization and efficiency, as well as the application of artificial intelligence in various sectors",
        ]
      },
    ]
  }}
